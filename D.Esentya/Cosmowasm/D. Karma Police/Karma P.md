`D_KARMA_POLICE_Architecture_Fractale.md`
...
| **Mémoire**        | **CHRONOS** | `ChronosEcho`    | Audit trail immutable. Decay des signalements inactifs.  |
...
**Monkey.**
*Le future Roi des Pirates qui code la Justice.*
